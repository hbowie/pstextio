...
/**
   ...
   Version History: <ul><li>
      2004/07/30 - Created for use with Two Due.  <li>
       </ul>
  
   @author Herb Bowie of PowerSurge Publishing
  
   @version 2004/07/30 - Created for use with Two Due. 
 */
public class TextBlock {
  ...
  private               StringBuffer  nextField     = new StringBuffer();
  private               List          labels;
